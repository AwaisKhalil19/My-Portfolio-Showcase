          ...
          <div id="hero-grid">
            ...
            <div id="hero-text">
              ...
              <motion.div initial={{ opacity:0, y:28 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.55, delay:0.44 }} className="hero-btns">
                ...
                <motion.a href="https://docs.google.com/document/d/e/2PACX-1vRAolCUrzH9fMFgT8WeY8BJWc7CIZCduv5vK6vVPvRhNsjHmtk5mf0v_fknS5JxvYvr6Rn-w7bYDwv3/pub" download whileHover={{ scale:1.05 }} whileTap={{ scale:0.95 }}
